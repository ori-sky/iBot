...
exports.Server = function(config)
{
	...
	var on_connect = function()
	{
		...
		exports.mods.fire('ibot$connect', this)
	...
	{
		exports.mods.instance = this.instance
		exports.mods.fire('ibot$disconnect', this)
		this.connect()
	}.bind(this)
	...
	{
		exports.mods.instance = this.instance
		exports.mods.fire('ibot$error', this, err)
		console.log(err)
	}.bind(this)
	...
	this.recv = function(data)
	{
		...
		{
			exports.mods.instance = this.instance
			exports.mods.fire('ibot$raw', this, data)
			exports.mods.fire('ibot$recv', this, message)
		}
		catch(e)
		{
			console.log(e.stack)
	...
	{
		exports.mods.instance = this.instance
		exports.mods.fire('ibot$send', this, data)
