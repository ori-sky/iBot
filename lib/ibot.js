...
exports.Server = function(config)
{
    ...
    {
        exports.__mods.fire('ibot$connect', this)
    ...
    {
        exports.__mods.fire('ibot$disconnect', this)
        this.connect()
    }.bind(this)

    var on_error = function(err)
    {
        exports.__mods.fire('ibot$error', this, err)
        console.log(err)
    }.bind(this)
    ...
    {
        exports.__mods.fire('ibot$send', this, data)
